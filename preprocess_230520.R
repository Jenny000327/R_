...
sub <- read_csv("상권영역_2021.csv")
dong <- read_csv("행정동코드_매핑정보_20200325.csv")
parking <- read_csv("주차장(동별)_2021.csv", skip = 3)
dense <- read_csv("인구밀도_2021.csv", skip = 1)
move <- read_csv("인구이동_2021.csv", skip = 0)
